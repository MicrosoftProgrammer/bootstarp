...
if ($_REQUEST['mode']=="del")
{
	...
	header("location:invoicegen.php?mode=deleted");
	die();
}
...
<html lang="en">
    ...
    <body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">General Invoice</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
               <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            View Invoice
                            <a href="../reports/geninvoicecreator.php" class="pull-right text-white">Add Invoice</a>
                        </div>
                        <!-- /.panel-heading -->
    ...
    <script>
        function fnStatus(arg)
        {
	        ...
	        {
		        document.location.href="invoicegen.php?mode=ret&&chkSelect[]=" + arg + "";
	        }
        }
    </script>
</html>